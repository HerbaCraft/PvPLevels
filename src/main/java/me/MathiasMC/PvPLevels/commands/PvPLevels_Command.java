										...
										new BukkitRunnable() {
											...
											public void run() {
												if (time >= seconds) {
													...
													time++;
													target.spigot().sendMessage(ChatMessageType.ACTION_BAR, TextComponent.fromLegacyText(ChatColor.translateAlternateColorCodes('&', Utils.replacePlaceholders(target, false, sb.toString().trim()))));
												}
											}
